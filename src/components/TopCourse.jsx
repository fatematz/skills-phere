        ...
        <div className="container py-[40px]">
            ...
            <div className="space-y-6 py-[40px]">
                {top3.map((course, index) => (
                    <div
                        key={course.id}
                        className={`flex flex-col md:flex-row items-center gap-6 bg-white p-6 rounded-2xl shadow-md
                    ...
                    >
                        ...
                        <div className="w-full md:w-1/2 space-y-3 text-left">
                            ...
                            <div className=" mt-3">
                                ...
                                <Link href={`/couresCard/${course.id}`}>
                                    <button className="bg-blue-200 block mt-4 hover:bg-blue-400 text-white px-4 py-2 w-[200px] border border-blue-400 rounded-lg transition duration-300">
                                        Details
                                    </button>
                                </Link>
                            </div>
